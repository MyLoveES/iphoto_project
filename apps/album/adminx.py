...
class AlbumAdmin(object):
    ...
    # list_filter = '__all__'
    list_display = ['id', "name", "user", "upload_time", "status", "description"]
    search_fields = ["name", "user"]
    list_editable = ["name", "user", "upload_time", "status", "description"]
    list_filter = ["name", "user", "upload_time", "status", "description"]
